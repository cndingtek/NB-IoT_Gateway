#/***********************************************************************************************************
# * Manhole Detector with level measurement DC413 Codec for nb-iot version.
...
class DC413(object):
    # Func: parse data to attr DC413 TCP
...
if __name__ == "__main__":
    try:
        ...
        attr_result = DC413.parse_data_DC413(incomingData)        
    except Exception as e:
        print(e)